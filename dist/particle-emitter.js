/*!
 * @bechstein/particle-emitter - v6.0.3
 * Compiled Fri, 24 May 2024 09:37:20 UTC
 *
 * @bechstein/particle-emitter is licensed under the MIT License.
...
(function (exports, pixi_js) {
    ...
    class PathBehavior {
        ...
        updateParticle(particle, deltaSec) {
            ...
            const random = particle.emitter.getBehavior('randomSeed');
    ...
    RandomSeedBehavior.type = 'randomSeed';
    RandomSeedBehavior.editorConfig = null;
    ...
    */
    ...
    Emitter.registerBehavior(RandomSeedBehavior);
